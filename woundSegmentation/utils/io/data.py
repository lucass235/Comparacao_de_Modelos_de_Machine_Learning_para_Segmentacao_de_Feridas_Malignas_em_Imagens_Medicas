        ...
        while True:
            ...
            for b in range(batch_size):
                ...
                if i < len(image_file_list):
                    ...
                    #print("image length: ----> " + str(len(image_file_list)))
                    #print("label length: ----> " + str(len(label_file_list)))
                    #print("path labels: ----> " + self.path_train_labels)
                    #print("path images: ----> " + self.path_test_images)
